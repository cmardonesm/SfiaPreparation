Proceso Stock
	...
	definir opc,mainCont,quitarCont,cantQuitar,modCant,elim,i,j,cantidad Como Entero;
	...
	Mientras salir=Falso Hacer
		...
		Escribir '3) REBAJAR INSUMOS:';
		Escribir '4) MODIFICAR INSUMOS:';
		Escribir '5) ELIMINAR INSUMOS:';
		Escribir '6) SALIR';
		Leer opc;
		...
		Segun opc Hacer
			...
			4:
				...
				Escribir '0) Salir';
				leer modCant;
				si modCant<>0 entonces 
					si modCant>maincont Entonces
				...
				finsi
			5:
				Escribir 'QUE INSUMO QUIERES ELIMINAR?';
				Para i<-0 Hasta mainCont-1 Hacer
					Escribir i+1,') ',insumos[i,0],'|',cantidad[i],insumos[i,1];
				FinPara
				leer elim;
				...
				SiNo
					elim<-elim-1;
					Para i<-elim Hasta mainCont-2 Hacer
